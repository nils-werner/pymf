...
class PCA(NMF):
    ...
    >>> pca_mdl = PCA(data, num_bases=2, compute_w=False)
    >>> pca_mdl.W = W
    >>> pca_mdl.factorize()
    ...
    def __init__(self, data, num_bases=0, init_w=True, init_h=True, center_mean=True):

        NMF.__init__(self, data, num_bases=num_bases, init_w=False, init_h=False)
